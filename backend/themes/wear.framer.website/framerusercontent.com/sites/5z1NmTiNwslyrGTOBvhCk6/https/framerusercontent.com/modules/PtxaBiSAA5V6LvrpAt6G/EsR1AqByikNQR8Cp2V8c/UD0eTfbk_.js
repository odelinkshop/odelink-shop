...
const Component = /*#__PURE__*/ React.forwardRef(function (props, ref) {
  ...
  return /*#__PURE__*/ _jsx(SVG, {
    ...restProps,
    className: cx("framer-SHCqu", className),
    layoutId: layoutId,
    ref: ref,
    role: "presentation",
    style: {
...
const css = [
  `.framer-SHCqu { -webkit-mask: ${mask}; aspect-ratio: 1; display: block; mask: ${mask}; width: 24px; }`,
];
/**
 ...
 */ const Icon = withCSS(Component, css, "framer-SHCqu");
  ...
  exports: {
    default: {
      ...
      annotations: {
        ...
        framerIntrinsicHeight: "24",
        framerVector:
          '{"name":"Instagram Logo","color":{"type":"variable","value":"21h8s6"},"set":{"localId":"vectorSet/NGVKdicsm","id":"NGVKdicsm","moduleId":"omX0gWFPqDwhaiWwf6ab"}}',
        framerImmutableVariables: "true",
        framerSupportedLayoutHeight: "any-prefer-fixed",
        framerSupportedLayoutWidth: "any-prefer-fixed",
      },
